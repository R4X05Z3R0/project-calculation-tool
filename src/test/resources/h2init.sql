-- Create the schema
CREATE SCHEMA IF NOT EXISTS aspect;
SET SCHEMA aspect;
...
CREATE TABLE subproject (
                            subproject_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE competency (
                            competency_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                            name VARCHAR(255) NOT NULL,
...
-- Project Data
INSERT INTO project (project_id, company_name, project_name, deadline, description, created_at) VALUES
